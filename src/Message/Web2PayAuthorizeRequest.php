...
/**
 * Flo2Cash Web Payments Authorize Request
 */
class Web2PayAuthorizeRequest extends AbstractRequest
{
    ...
    {
        return $this->response = new Web2PayAuthorizeResponse($this, $data);
    }
}
