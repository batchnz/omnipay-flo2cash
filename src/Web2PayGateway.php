...
class Web2PayGateway extends AbstractGateway
{
    ...
    //  * Flo2Cash recommends that you provide an image that is stored on a secure
    //  * (HTTPS) server.
    ...
    {
        return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressAuthorizeRequest', $parameters);
    }

    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressCompletePurchaseRequest', $parameters);
    }

    // public function void(array $parameters = array())
    // {
    //     return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressVoidRequest', $parameters);
    // }

    // public function fetchCheckout(array $parameters = array())
    // {
    //     return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressFetchCheckoutRequest', $parameters);
    // }
    ...
    // {
    //     return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressTransactionSearchRequest', $parameters);
    // }

    // public function order(array $parameters = array())
    // {
    //     return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressOrderRequest', $parameters);
    // }

    // public function completeOrder(array $parameters = array())
    // {
    //     return $this->createRequest('\Omnipay\Flo2Cash\Message\ExpressCompleteOrderRequest', $parameters);
    // }
}
